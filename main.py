...
CONFIG = get_config(
    full_file_path="/media/alex/drive_2tb/y_eda_tg_bot/misc/config.json"
)

if CONFIG["data_source_type"] == "db_file":
    from back.sqlite3_manager import sqlite3_manager_init, calculate_distance, add_log
    from datetime import datetime

    sqlite3_manager_init(
